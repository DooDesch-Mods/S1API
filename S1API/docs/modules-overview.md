...
**Documentation**: See [Avatar Equippable Prefabs](avatar-equippable-prefabs.md) for AssetBundle usage
...
1. **New to S1API?** Start with [Installation](installation.md), then [Quickstart](quickstart.md)
2. **Want to understand runtime support?** Read [Cross-Compatibility](api-overview.md)
3. **Want to create NPCs?** Read [Custom NPCs](custom-npcs.md)
4. **Building a phone app?** See [Phone Apps](phone-app.md)
...
- **[S1API NPC Examples](https://github.com/ifBars/S1APINPCExample)** - Complete custom NPC implementations with schedules, dialogue, customers, dealers, and UI integration
- **[More-NPCs](https://github.com/fannsonetti/More-NPCs)** - Additional custom NPC examples from a real mod
- **[S1NotesApp](https://github.com/ifBars/S1NotesApp)** - Phone app example with save data and quest integration
- **[HelloWorldTVApp](https://github.com/HazDS/HelloWorldTVApp)** - Minimal TV app example
